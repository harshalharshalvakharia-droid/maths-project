...
\begin{keyresult}{Eigenvalue Result}
  \[
    \lambda_1 \approx 0.892 \qquad \lambda_2 \approx 0.299 \qquad
    \sigma_1 = \sqrt{\lambda_1} \approx 0.944 \qquad \sigma_2 = \sqrt{\lambda_2} \approx 0.547
  \]
  \[
    \boxed{\kappa = \frac{\sigma_1}{\sigma_2} \approx 1.73 \quad \Rightarrow \quad \text{Well-conditioned --- stable training expected.}}
  \]
\end{keyresult}
...
\begin{table}[H]
  ...
  \begin{tabular}{lcccc}
    \toprule
    \textbf{Method} & \textbf{Information Used} & \textbf{Cost/Step} & \textbf{Convergence} & \textbf{CME202 Topic}\\
    \midrule
...
\begin{table}[H]
  ...
  \begin{tabular}{llll}
    ...
    Fourier Analysis      & Sigmoid frequency structure        & Dominant coefficient $b_1$ & $\approx 0.391$ \\
...
\[
  G_{11} = 0.5^2 + 0.2^2 + 0.1^2 = 0.30, \quad
  G_{12} = (0.5)(-0.3) + (0.2)(0.8) + (-0.1)(0.4) = -0.03, \quad
...
\[
  ...
  \;\Rightarrow\;
  \boxed{\lambda_1 \approx 0.892, \quad \lambda_2 \approx 0.299, \quad \kappa = \sqrt{\lambda_1/\lambda_2} \approx 1.73}
\]
...
\begin{center}
  ...
  {\small\color{gray} Navrachana University | School of Engineering and Technology | 2026}
\end{center}
...
\begin{tabular}{>{\bfseries}p{5cm} p{9cm}}
  ...
  \midrule
  Harshal Vakhariya & All Python code (neural network, training, math plots, live dashboard, animation), all mathematical modelling and derivations, full \LaTeX\ report writing and typesetting, GitHub repository setup and documentation \\
  \bottomrule
\end{tabular}
...
\begin{center}
  \small\color{gray}
  Full project credits and acknowledgements available at:\\
  \url{https://github.com/harshalharshalvakharia-droid/maths-project/blob/main/CREDITS.md}
\end{center}
