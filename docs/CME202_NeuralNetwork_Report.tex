...
\rhead{\textcolor{navrachana}{\small CME202 \textendash{} Mathematics II \textbar{} Neural Networks}}
\lhead{\textcolor{navrachana}{\small Navrachana University}}
...
% University logo
\includegraphics[width=4.5cm]{navrachana_logo.png}\\[0.5cm]
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{nn_architecture.png}
...
\begin{table}[H]
  \centering
  \caption{CME202 mathematics topics and their role in neural network training}
  \renewcommand{\arraystretch}{1.3}
  \begin{tabular}{llll}
    \toprule
...
\begin{itemize}[leftmargin=2em, itemsep=4pt]
  \item Analyse gradient descent as a discrete dynamical system using the ODE stability framework from CME202, to formally characterise the convergence radius.
